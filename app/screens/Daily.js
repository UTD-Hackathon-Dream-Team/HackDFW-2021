  ...
  return (
    <NativeBaseProvider config={config}>
      <Box bg={styles.bg} style={{ flex: 1 }}>
        ...
        <Box bg={styles.cardbg} style={styles.box} m="2" p="7" rounded="xl">
          {plan.activities && (
        ...
        <Box bg={styles.cardbg} style={styles.box} m="2" p="7" rounded="xl">
          ...
          <Text fontSize="md">
            Help Ebony collect fruits for her pie! Keep finishing your daily
            tasks to collect more fruit and give them to her for gems!
          </Text>
        </Box>
        <Image
          style={{
